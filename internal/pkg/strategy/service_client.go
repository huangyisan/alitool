...
func (*SSLClient) NewClient(regionId, accessKeyId, accessKeySecret string) (interface{}, error) {
	return cas.NewClientWithAccessKey(regionId, accessKeyId, accessKeySecret)
}
